...
CREATE TABLE IF NOT EXISTS meta_ads_config (
    ...
    -- Надбавка банку до курсу НБУ. monobank НЕ показує комісію окремим рядком
    -- («Комісія (грн): 0.00»), а зашиває її в курс: чек від 30.08.2026 на
    -- 87,00 USD = 3897,67 ₴ за курсом 44,8008, тоді як НБУ того дня 44,5445.
    -- Звідси 44.8008/44.5445 − 1 = 0.5754%. Чотири знаки, а не три, саме тому:
    -- на 0.575 той самий чек дає 3897,65 — розходження на 2 копійки.

...
def remove_old_suffix_duplicates(conn):
   ...
   НО! Якщо товар використовується у order_items, ми не видаляємо, щоби не лягла цілісність.
   """
...
def import_data():
   ...
   2) Видаляємо (м'яко) товари з суфіксом "...( )", які НЕ використовуються у order_items.

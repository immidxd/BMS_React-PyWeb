...
VALUE_HINTS: Dict[str, Dict[str, str]] = {
    ...
    # Протектор. Рішення власника 15.09.2026 (Caprice #Ф4402, ботильйони з
    # тонкою насічкою на каблуці, які модель назвала «рифлена»): «маленькі
    # вирізи і незначні рифленості — не рифлена підошва, і навіть не
    # рельєфна». Попереднє визначення «дрібні… неглибокий малюнок» саме й
    # запрошувало називати мікротекстуру рифленням.
    # Друге рішення того ж дня (#Ф4408): підошва з ПРЯМОКУТНИХ БЛОКІВ і
    # шевронів — «рельєфна», не «рифлена». Модель бачила рівчаки між блоками
    # й називала рифленням. Різниця — у ФОРМІ малюнка, не в глибині:
    # лінії → рифлена; фігури → рельєфна; глибокі шашки з широкими
    # проміжками → тракторна.
    "tread_type": {
        "__field__": "порядок рішення: (1) рівна підошва або лише НЕГЛИБОКИЙ малюнок — мікротекстура, тонкі лінії, невеликі вирізи чи насічки на каблуці, тиснений логотип — «гладка»; (2) густі паралельні ребра/зубці в одному напрямку по всій підошві — «рифлена»; (3) глибокі масивні шашки з широкими проміжками — «тракторна»; (4) УСЕ ІНШЕ з виразним протектором, що не підходить під (2) і (3), — «рельєфна» (це типовий вибір для справжнього протектора). Класичні туфлі, ботильйони, лофери майже завжди «гладка»",
        "гладка":    "рівна підошва; сюди ж усе з НЕГЛИБОКИМ малюнком — мікротекстура, тонкі лінії, дрібні вирізи або насічка на каблуці, тиснений логотип бренда; неглибокий малюнок протектором не вважається",
        "рифлена":   "густі паралельні ребра або зубці в ОДНОМУ напрямку по всій площі підошви, збоку схожі на пилку чи гофру (типово: EA7/Armani, платформи-«креперси», ретро-кросівки); жодних фігур між ребрами; якщо ребра утворюють блоки, ромби чи шеврони — це «рельєфна»",
        "рельєфна":  "будь-який ВИРАЗНИЙ протектор, який не є ані паралельними ребрами, ані глибокими шашками з широкими проміжками: блоки, ромби, шеврони, соти, хвилі, змішані малюнки — типова підошва кросівок, грубих черевиків і ботинок; за сумніву між «рифлена»/«тракторна» і «рельєфна» — «рельєфна»",
        "тракторна": "глибокі масивні шашки з ШИРОКИМИ проміжками між ними, як у протектора трактора чи трекінгових черевиків",
    },
}

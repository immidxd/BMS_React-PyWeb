...
VALUE_HINTS: Dict[str, Dict[str, str]] = {
    ...
    "tread_type": {
        "__field__": "спершу визнач ФОРМУ малюнка: лише паралельні ЛІНІЇ в одному напрямку — «рифлена»; будь-які ФІГУРИ (прямокутники, блоки, ромби, шеврони, соти, хвилі в різних напрямках) — «рельєфна»; глибокі масивні шашки з широкими проміжками — «тракторна». Протектор має бути очевидним здалеку; дрібна текстура, тонкі лінії, невеликі вирізи чи насічки на каблуці, тиснений логотип — «гладка»; сумнів між «гладка» і рештою — завжди «гладка»; класичні туфлі, ботильйони, лофери майже завжди «гладка»",
        "гладка":    "рівна підошва; сюди ж мікротекстура, тонкі лінії, дрібні вирізи або насічка на каблуці, тиснений логотип бренда — усе, що не є справжнім протектором",
        "рифлена":   "ЛИШЕ паралельні прямі рівчаки в одному напрямку по всій площі, як гофра чи пральна дошка; жодних фігур між ними; глибокі й помітні здалеку; якщо рівчаки утворюють блоки, ромби чи шеврони — це вже «рельєфна»",
        "рельєфна":  "малюнок із ФІГУР — прямокутні блоки, ромби, шеврони, соти, хвилі різних напрямків — обʼємний, по всій підошві, з вузькими проміжками; типова підошва грубих черевиків і ботинок; НЕ дрібна текстура і НЕ глибокі шашки з широкими проміжками",

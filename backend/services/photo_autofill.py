...
VALUE_HINTS: Dict[str, Dict[str, str]] = {
    ...
    "tread_type": {
        "__field__": "протектор має бути ОЧЕВИДНИМ здалеку; дрібна текстура, тонкі лінії, невеликі вирізи чи насічки на каблуці, тиснений логотип — це «гладка»; сумнів між «гладка» і «рифлена»/«рельєфна» — завжди «гладка»; класичні туфлі, ботильйони, лофери майже завжди «гладка»",
        ...
        "рифлена":   "виразні паралельні рівчаки по ВСІЙ площі підошви, глибокі (від ~2 мм) і помітні здалеку — як на кросівках чи грубих черевиках; не дрібна насічка",
        "рельєфна":  "виразний обʼємний малюнок (хвилі, соти, фігури) по всій підошві, помітний здалеку; НЕ дрібна текстура і НЕ глибокі шашки",

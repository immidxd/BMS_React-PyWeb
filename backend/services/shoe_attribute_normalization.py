...
TOE_SHAPE: Final[dict[str, tuple[str, ...]]] = {
    "круглий":     ("кругла", "круголий"),            # 428 ← 7+1
    # Рішення власника 15.09.2026: «заокруглена» — ОКРЕМА форма, а не варіант
    # «круглого»: носок звужується, але кінчик округлий (класичні туфлі,
    # ботильйони, лофери). До того «заокруглений» (4) і «закруглений» (1)
    # зливались у «круглий» — ті 5 товарів уже не відрізнити. «Мигдалевидний»
    # — те саме поняття іншим словом: модель написала його на #Ф4407, власник
    # виправив руками на «заокруглена». Рід — як пише власник у Журналі.
    "заокруглена": ("заокруглений", "закруглений", "мигдалевидний",
                    "мигдалевидна", "мигдалеподібний", "almond"),
...
ABSENCE_VALUES: Final[dict[str, tuple[str, ...]]] = {
    ...
    # «Unknown» у країнах (257 товарів) — це відсутність, не країна.
    "manufacturer_country_name": ("unknown", "невідомо"),
}

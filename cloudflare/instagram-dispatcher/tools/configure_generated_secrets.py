"""Створює Instagram secrets без виведення значень у термінал або чат."""
...
ENV_FILE = ROOT / ".env"
WORKER_URL = "https://bms-instagram-dispatcher.vanya-malashenko-2002.workers.dev"
...
def main() -> None:
    ...
    update_env({
        "INSTAGRAM_DISPATCHER_URL": WORKER_URL,
        "INSTAGRAM_DISPATCHER_KEY": dispatcher_key,
    })
    print("Instagram generated secrets configured; values were not displayed.")
